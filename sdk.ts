...
class AppConfig {
    ...
    private constructor() {
        ...
        this.signer = Keypair.fromSecretKey(bs58.decode(this.config.privateKey))
    }
...
class SdkFunctions {
    ...
    public static getProvider(connectionType: string, isPump = false): any {
        switch (connectionType.toLowerCase()) {
            case "grpc":
                return isPump
                    ? SdkFunctions.appConfig.grpcProviderPump
                    : SdkFunctions.appConfig.grpcProvider
            case "http":
                return isPump
                    ? SdkFunctions.appConfig.httpProviderPump
                    : SdkFunctions.appConfig.httpProvider
            case "websocket":
                const wsProvider = isPump
                    ? SdkFunctions.appConfig.wsProviderPump
                    : SdkFunctions.appConfig.wsProvider
                wsProvider.connect()
                return wsProvider
            default:
                throw new Error(
     ...
     */
    public static async postSubmit(
        protocol: string,
        network: string
    ): Promise<SdkFunctionResult> {
        try {
            const signer = SdkFunctions.appConfig.signer
            const bloxrouteTipWallet = new PublicKey(
     ...
     */
    public static async postSubmitV2(
        protocol: string,
        network: string
    ): Promise<SdkFunctionResult> {
        try {
     ...
     */
    public static async postSubmitPaladinV2(
        protocol: string,
        network: string
    ): Promise<SdkFunctionResult> {
        try {
     ...
     */
    public static async postSubmitSnipeV2(
        protocol: string,
        network: string
    ): Promise<SdkFunctionResult> {
        try {
     ...
     */
    public static async postPumpFunSwapSol(
        protocol: string,
        network: string
    ): Promise<SdkFunctionResult> {
        try {
            ...
            const newTokens = await SdkFunctions.getPumpFunNewTokensStream(
                protocol,
                network,
                1
            )
     ...
     */
    public static async getRecentBlockHashStream(
        protocol: string,
        network: string,
        times = 5
    ): Promise<SdkFunctionResult> {
     ...
     */
    public static async getPriorityFeeStream(
        protocol: string,
        network: string,
        times = 5
    ): Promise<SdkFunctionResult> {
     ...
     */
    public static async getBundleTipStream(
        protocol: string,
        network: string,
        times = 1
    ): Promise<SdkFunctionResult> {
     ...
     */
    public static async getPumpFunNewAmmPoolStream(
        protocol: string,
        network: string,
        times = 5
    ): Promise<SdkFunctionResult> {
     ...
     */
    public static async getPumpFunNewTokensStream(
        protocol: string,
        network: string,
        times = 1
    ): Promise<SdkFunctionResult> {
     ...
     */
    public static async getPumpFunSwapsStream(
        protocol: string,
        network: string,
        times = 1
    ): Promise<SdkFunctionResult> {
     ...
     */
    public static async getPumpFunAmmSwapStream(
        protocol: string,
        network: string,
        times = 1
    ): Promise<SdkFunctionResult> {
     ...
     */
    public static async getNewRaydiumPoolsStream(
        protocol: string,
        network: string,
        times = 1
    ): Promise<SdkFunctionResult> {
     ...
     */
    public static async getNewRaydiumPoolsByTransactionStream(
        protocol: string,
        network: string,
        times = 5
    ): Promise<SdkFunctionResult> {
        try {
            ...
            const provider = SdkFunctions.getProvider(protocol)
            const stream = await provider.getNewRaydiumPoolsByTransactionStream(
                request
            )
     ...
     * Get token accounts
     */
    public static async getTokenAccounts(
        protocol: string,
        network: string
    ): Promise<SdkFunctionResult> {
        try {
    ...
    public static getAvailableFunctions(
        ...
        return {
            ...
            GetNewRaydiumPoolsByTransactionStream:
                SdkFunctions.getNewRaydiumPoolsByTransactionStream,
        }
    }
}
...
class UserInterface {
    ...
    public static async displayBanner(): Promise<void> {
        ...
        console.log(
            "\n" +
                chalk.bold(
                    " Welcome to the BloxRoute SDK for TypeScript - Solana Trader"
                ) +
                "\n"
        )
        console.log(
            chalk.dim(
                " Interactive CLI for exploring the BloxRoute SDK functionality"
            )
        )
        console.log(
            chalk.dim(" Use your arrow keys to navigate through the menus") +
                "\n"
        )
    }
     ...
     */
    public static async selectFunction(
        ...
        const { action } = await inquirer.prompt([
            {
                ...
                choices: [
                    ...
                    {
                        name: "Change protocol/network settings",
                        value: "change",
                    },
...
class BloxRouteCliApp {
    ...
    private async executeFunction(functionName: string): Promise<void> {
        ...
        try {
            const result = await this.sdkFunctions[functionName](
                this.connectionType,
                this.network
            )
    ...
    private async configureSettings(): Promise<void> {
        ...
        console.log(
            chalk.green(`Selected connection type: ${this.connectionType}`)
        )
    ...
    public async run(): Promise<void> {
        ...
        while (continueRunning) {
            ...
            const selectedFunction = await UserInterface.selectFunction(
                availableFunctions
            )
