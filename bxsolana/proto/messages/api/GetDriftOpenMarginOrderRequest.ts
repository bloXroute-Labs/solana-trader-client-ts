...
export declare namespace $.api {
  export interface GetDriftOpenMarginOrderRequest {
    ownerAddress: string;
...
export type Type = $.api.GetDriftOpenMarginOrderRequest;

export function getDefaultValue(): $.api.GetDriftOpenMarginOrderRequest {
  return {
    ownerAddress: "",
    accountAddress: "",
    orderID: "0",
...
export function createValue(partialValue: Partial<$.api.GetDriftOpenMarginOrderRequest>): $.api.GetDriftOpenMarginOrderRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetDriftOpenMarginOrderRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetDriftOpenMarginOrderRequest {
...
export function encodeBinary(value: $.api.GetDriftOpenMarginOrderRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetDriftOpenMarginOrderRequest {
  const result = getDefaultValue();
