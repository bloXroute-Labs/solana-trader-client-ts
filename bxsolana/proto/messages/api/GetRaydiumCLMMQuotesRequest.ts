...
export declare namespace $.api {
  export interface GetRaydiumCLMMQuotesRequest {
    inToken: string;
    outToken: string;
    inAmount: number;
    slippage: number;
...
export type Type = $.api.GetRaydiumCLMMQuotesRequest;

export function getDefaultValue(): $.api.GetRaydiumCLMMQuotesRequest {
  return {
    inToken: "",
    outToken: "",
    inAmount: 0,
...
export function createValue(partialValue: Partial<$.api.GetRaydiumCLMMQuotesRequest>): $.api.GetRaydiumCLMMQuotesRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetRaydiumCLMMQuotesRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetRaydiumCLMMQuotesRequest {
...
export function encodeBinary(value: $.api.GetRaydiumCLMMQuotesRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetRaydiumCLMMQuotesRequest {
  const result = getDefaultValue();
