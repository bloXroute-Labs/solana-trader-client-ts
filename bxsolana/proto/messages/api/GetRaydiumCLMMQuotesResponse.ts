...
export declare namespace $.api {
  export interface GetRaydiumCLMMQuotesResponse {
    inToken: string;
...
export type Type = $.api.GetRaydiumCLMMQuotesResponse;

export function getDefaultValue(): $.api.GetRaydiumCLMMQuotesResponse {
  return {
    inToken: "",
    inTokenAddress: "",
    outToken: "",
...
export function createValue(partialValue: Partial<$.api.GetRaydiumCLMMQuotesResponse>): $.api.GetRaydiumCLMMQuotesResponse {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetRaydiumCLMMQuotesResponse): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetRaydiumCLMMQuotesResponse {
...
export function encodeBinary(value: $.api.GetRaydiumCLMMQuotesResponse): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetRaydiumCLMMQuotesResponse {
  const result = getDefaultValue();
