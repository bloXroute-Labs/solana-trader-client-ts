...
export declare namespace $.api {
  export interface PostRaydiumCLMMRouteSwapResponse {
    transactions: TransactionMessage[];
    outAmount: number;
    outAmountMin: number;
  }
}
export type Type = $.api.PostRaydiumCLMMRouteSwapResponse;

export function getDefaultValue(): $.api.PostRaydiumCLMMRouteSwapResponse {
  return {
    transactions: [],
    outAmount: 0,
    outAmountMin: 0,
...
export function createValue(partialValue: Partial<$.api.PostRaydiumCLMMRouteSwapResponse>): $.api.PostRaydiumCLMMRouteSwapResponse {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.PostRaydiumCLMMRouteSwapResponse): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.PostRaydiumCLMMRouteSwapResponse {
...
export function encodeBinary(value: $.api.PostRaydiumCLMMRouteSwapResponse): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.PostRaydiumCLMMRouteSwapResponse {
  const result = getDefaultValue();
