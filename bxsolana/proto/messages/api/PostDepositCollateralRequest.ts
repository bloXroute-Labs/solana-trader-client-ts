...
export declare namespace $.api {
  export interface PostDepositCollateralRequest {
    ownerAddress: string;
    amount: number;
    project: Project;
...
export type Type = $.api.PostDepositCollateralRequest;

export function getDefaultValue(): $.api.PostDepositCollateralRequest {
  return {
    ownerAddress: "",
    amount: 0,
    project: "P_UNKNOWN",
...
export function createValue(partialValue: Partial<$.api.PostDepositCollateralRequest>): $.api.PostDepositCollateralRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.PostDepositCollateralRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.PostDepositCollateralRequest {
...
export function encodeBinary(value: $.api.PostDepositCollateralRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.PostDepositCollateralRequest {
  const result = getDefaultValue();
