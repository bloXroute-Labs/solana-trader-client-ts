import {
  Type as InstructionRaydium,
  encodeJson as encodeJson_1,
  decodeJson as decodeJson_1,
  encodeBinary as encodeBinary_1,
  decodeBinary as decodeBinary_1,
} from "./InstructionRaydium";
import {
...
export declare namespace $.api {
  export interface PostRaydiumSwapInstructionsResponse {
...
export type Type = $.api.PostRaydiumSwapInstructionsResponse;

export function getDefaultValue(): $.api.PostRaydiumSwapInstructionsResponse {
  return {
    instructions: [],
    outAmount: 0,
    outAmountMin: 0,
...
export function createValue(partialValue: Partial<$.api.PostRaydiumSwapInstructionsResponse>): $.api.PostRaydiumSwapInstructionsResponse {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.PostRaydiumSwapInstructionsResponse): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.PostRaydiumSwapInstructionsResponse {
...
export function encodeBinary(value: $.api.PostRaydiumSwapInstructionsResponse): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.PostRaydiumSwapInstructionsResponse {
  const result = getDefaultValue();
