...
export function createValue(partialValue: Partial<$.api.QuoteStep>): $.api.QuoteStep {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.QuoteStep): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.QuoteStep {
...
export function encodeBinary(value: $.api.QuoteStep): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.QuoteStep {
  const result = getDefaultValue();
