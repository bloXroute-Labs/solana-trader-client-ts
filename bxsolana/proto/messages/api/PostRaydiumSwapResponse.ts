...
export declare namespace $.api {
  export interface PostRaydiumSwapResponse {
...
export type Type = $.api.PostRaydiumSwapResponse;

export function getDefaultValue(): $.api.PostRaydiumSwapResponse {
  return {
    transactions: [],
    outAmount: 0,
    outAmountMin: 0,
...
export function createValue(partialValue: Partial<$.api.PostRaydiumSwapResponse>): $.api.PostRaydiumSwapResponse {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.PostRaydiumSwapResponse): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.PostRaydiumSwapResponse {
...
export function encodeBinary(value: $.api.PostRaydiumSwapResponse): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.PostRaydiumSwapResponse {
  const result = getDefaultValue();
