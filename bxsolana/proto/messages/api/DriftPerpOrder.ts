...
export declare namespace $.api {
  export interface DriftPerpOrder {
    orderID: string;
...
export type Type = $.api.DriftPerpOrder;

export function getDefaultValue(): $.api.DriftPerpOrder {
  return {
    orderID: "0",
    clientOrderID: "0",
    contract: "",
...
export function createValue(partialValue: Partial<$.api.DriftPerpOrder>): $.api.DriftPerpOrder {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.DriftPerpOrder): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.DriftPerpOrder {
...
export function encodeBinary(value: $.api.DriftPerpOrder): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.DriftPerpOrder {
  const result = getDefaultValue();
