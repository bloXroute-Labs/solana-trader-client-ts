...
export declare namespace $.api {
  export interface GetOpenPerpOrdersRequest {
    project: Project;
    ownerAddress: string;
...
export type Type = $.api.GetOpenPerpOrdersRequest;

export function getDefaultValue(): $.api.GetOpenPerpOrdersRequest {
  return {
    project: "P_UNKNOWN",
    ownerAddress: "",
    accountAddress: "",
...
export function createValue(partialValue: Partial<$.api.GetOpenPerpOrdersRequest>): $.api.GetOpenPerpOrdersRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetOpenPerpOrdersRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetOpenPerpOrdersRequest {
...
export function encodeBinary(value: $.api.GetOpenPerpOrdersRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetOpenPerpOrdersRequest {
  const result = getDefaultValue();
