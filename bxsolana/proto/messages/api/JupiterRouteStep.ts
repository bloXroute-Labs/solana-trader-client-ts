...
export type Type = $.api.JupiterRouteStep;

export function getDefaultValue(): $.api.JupiterRouteStep {
  return {
    inToken: "",
    inAmount: 0,
    outToken: "",
...
export function createValue(partialValue: Partial<$.api.JupiterRouteStep>): $.api.JupiterRouteStep {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.JupiterRouteStep): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.JupiterRouteStep {
...
export function encodeBinary(value: $.api.JupiterRouteStep): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.JupiterRouteStep {
  const result = getDefaultValue();
