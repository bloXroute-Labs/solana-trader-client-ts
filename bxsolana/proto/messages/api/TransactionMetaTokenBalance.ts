...
export type Type = $.api.TransactionMetaTokenBalance;

export function getDefaultValue(): $.api.TransactionMetaTokenBalance {
  return {
    accountIndex: 0,
    mint: "",
...
export function createValue(partialValue: Partial<$.api.TransactionMetaTokenBalance>): $.api.TransactionMetaTokenBalance {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.TransactionMetaTokenBalance): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.TransactionMetaTokenBalance {
...
export function encodeBinary(value: $.api.TransactionMetaTokenBalance): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.TransactionMetaTokenBalance {
  const result = getDefaultValue();
