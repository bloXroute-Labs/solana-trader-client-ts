import {
  Type as DriftMarginOrderbookItem,
  encodeJson as encodeJson_1,
  decodeJson as decodeJson_1,
  encodeBinary as encodeBinary_1,
  decodeBinary as decodeBinary_1,
} from "./DriftMarginOrderbookItem";
import {
...
export declare namespace $.api {
  export interface GetDriftMarginOrderbookValue {
    market: string;
    marketAddress: string;
    bids: DriftMarginOrderbookItem[];
    asks: DriftMarginOrderbookItem[];
  }
}
export type Type = $.api.GetDriftMarginOrderbookValue;

export function getDefaultValue(): $.api.GetDriftMarginOrderbookValue {
  return {
    market: "",
    marketAddress: "",
    bids: [],
...
export function createValue(partialValue: Partial<$.api.GetDriftMarginOrderbookValue>): $.api.GetDriftMarginOrderbookValue {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetDriftMarginOrderbookValue): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetDriftMarginOrderbookValue {
...
export function encodeBinary(value: $.api.GetDriftMarginOrderbookValue): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetDriftMarginOrderbookValue {
  const result = getDefaultValue();
