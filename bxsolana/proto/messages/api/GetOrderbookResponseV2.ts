import {
  Type as OrderbookItemV2,
  encodeJson as encodeJson_1,
  decodeJson as decodeJson_1,
  encodeBinary as encodeBinary_1,
  decodeBinary as decodeBinary_1,
} from "./OrderbookItemV2";
import {
...
export declare namespace $.api {
  export interface GetOrderbookResponseV2 {
    market: string;
    marketAddress: string;
    bids: OrderbookItemV2[];
    asks: OrderbookItemV2[];
  }
}
export type Type = $.api.GetOrderbookResponseV2;

export function getDefaultValue(): $.api.GetOrderbookResponseV2 {
  return {
    market: "",
    marketAddress: "",
    bids: [],
...
export function createValue(partialValue: Partial<$.api.GetOrderbookResponseV2>): $.api.GetOrderbookResponseV2 {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetOrderbookResponseV2): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetOrderbookResponseV2 {
...
export function encodeBinary(value: $.api.GetOrderbookResponseV2): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetOrderbookResponseV2 {
  const result = getDefaultValue();
