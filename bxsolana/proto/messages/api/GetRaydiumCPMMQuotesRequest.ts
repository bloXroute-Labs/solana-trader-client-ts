...
export declare namespace $.api {
  export interface GetRaydiumCPMMQuotesRequest {
    inToken: string;
    outToken: string;
    inAmount: number;
    slippage: number;
...
export type Type = $.api.GetRaydiumCPMMQuotesRequest;

export function getDefaultValue(): $.api.GetRaydiumCPMMQuotesRequest {
  return {
    inToken: "",
    outToken: "",
    inAmount: 0,
...
export function createValue(partialValue: Partial<$.api.GetRaydiumCPMMQuotesRequest>): $.api.GetRaydiumCPMMQuotesRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetRaydiumCPMMQuotesRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetRaydiumCPMMQuotesRequest {
...
export function encodeBinary(value: $.api.GetRaydiumCPMMQuotesRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetRaydiumCPMMQuotesRequest {
  const result = getDefaultValue();
