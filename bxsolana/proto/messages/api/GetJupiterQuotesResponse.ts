import {
  Type as JupiterQuoteRoute,
  encodeJson as encodeJson_1,
  decodeJson as decodeJson_1,
  encodeBinary as encodeBinary_1,
  decodeBinary as decodeBinary_1,
} from "./JupiterQuoteRoute";
import {
...
export declare namespace $.api {
  export interface GetJupiterQuotesResponse {
    inToken: string;
    inTokenAddress: string;
    outToken: string;
    outTokenAddress: string;
    inAmount: number;
    routes: JupiterQuoteRoute[];
  }
}
export type Type = $.api.GetJupiterQuotesResponse;

export function getDefaultValue(): $.api.GetJupiterQuotesResponse {
  return {
    inToken: "",
    inTokenAddress: "",
    outToken: "",
...
export function createValue(partialValue: Partial<$.api.GetJupiterQuotesResponse>): $.api.GetJupiterQuotesResponse {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetJupiterQuotesResponse): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetJupiterQuotesResponse {
...
export function encodeBinary(value: $.api.GetJupiterQuotesResponse): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetJupiterQuotesResponse {
  const result = getDefaultValue();
