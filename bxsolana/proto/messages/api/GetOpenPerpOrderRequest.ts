...
export type Type = $.api.GetOpenPerpOrderRequest;

export function getDefaultValue(): $.api.GetOpenPerpOrderRequest {
  return {
    ownerAddress: "",
    accountAddress: "",
    contract: "ALL",
...
export function createValue(partialValue: Partial<$.api.GetOpenPerpOrderRequest>): $.api.GetOpenPerpOrderRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.GetOpenPerpOrderRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.GetOpenPerpOrderRequest {
...
export function encodeBinary(value: $.api.GetOpenPerpOrderRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.GetOpenPerpOrderRequest {
  const result = getDefaultValue();
