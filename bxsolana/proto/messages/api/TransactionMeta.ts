...
} from "./TransactionMetaInnerInstruction";
import {
...
} from "./TransactionMetaTokenBalance";
import {
...
export type Type = $.api.TransactionMeta;

export function getDefaultValue(): $.api.TransactionMeta {
  return {
    err: "",
    errored: false,
    fee: "0",
...
export function createValue(partialValue: Partial<$.api.TransactionMeta>): $.api.TransactionMeta {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.TransactionMeta): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.TransactionMeta {
...
export function encodeBinary(value: $.api.TransactionMeta): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.TransactionMeta {
  const result = getDefaultValue();
