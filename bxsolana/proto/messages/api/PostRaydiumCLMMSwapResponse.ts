...
export declare namespace $.api {
  export interface PostRaydiumCLMMSwapResponse {
    transactions: TransactionMessage[];
    outAmount: number;
    outAmountMin: number;
  }
}
export type Type = $.api.PostRaydiumCLMMSwapResponse;

export function getDefaultValue(): $.api.PostRaydiumCLMMSwapResponse {
  return {
    transactions: [],
    outAmount: 0,
    outAmountMin: 0,
...
export function createValue(partialValue: Partial<$.api.PostRaydiumCLMMSwapResponse>): $.api.PostRaydiumCLMMSwapResponse {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.PostRaydiumCLMMSwapResponse): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.PostRaydiumCLMMSwapResponse {
...
export function encodeBinary(value: $.api.PostRaydiumCLMMSwapResponse): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.PostRaydiumCLMMSwapResponse {
  const result = getDefaultValue();
