...
export declare namespace $.api {
  export interface PostPumpFunAmmSwapRequest {
    ownerAddress: string;
    inToken: string;
    outToken: string;
    pool: string;
...
export type Type = $.api.PostPumpFunAmmSwapRequest;

export function getDefaultValue(): $.api.PostPumpFunAmmSwapRequest {
  return {
    ownerAddress: "",
    inToken: "",
    outToken: "",
...
export function createValue(partialValue: Partial<$.api.PostPumpFunAmmSwapRequest>): $.api.PostPumpFunAmmSwapRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.PostPumpFunAmmSwapRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.PostPumpFunAmmSwapRequest {
...
export function encodeBinary(value: $.api.PostPumpFunAmmSwapRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.PostPumpFunAmmSwapRequest {
  const result = getDefaultValue();
