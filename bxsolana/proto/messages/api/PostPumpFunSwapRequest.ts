...
export function encodeJson(value: $.api.PostPumpFunSwapRequest): unknown {
  ...
  if (value.jitoDontFront !== undefined) result.jitoDontFront = tsValueToJsonValueFns.bool(value.jitoDontFront);
  return result;
}
...
export function decodeJson(value: any): $.api.PostPumpFunSwapRequest {
  ...
  if (value.jitoDontFront !== undefined) result.jitoDontFront = jsonValueToTsValueFns.bool(value.jitoDontFront);
  return result;
}
...
export function encodeBinary(value: $.api.PostPumpFunSwapRequest): Uint8Array {
  ...
  if (value.jitoDontFront !== undefined) {
    const tsValue = value.jitoDontFront;
    result.push(
