...
export declare namespace $.api {
  export interface PostJupiterRouteSwapResponse {
...
export type Type = $.api.PostJupiterRouteSwapResponse;

export function getDefaultValue(): $.api.PostJupiterRouteSwapResponse {
  return {
    transactions: [],
    outAmount: 0,
    outAmountMin: 0,
...
export function createValue(partialValue: Partial<$.api.PostJupiterRouteSwapResponse>): $.api.PostJupiterRouteSwapResponse {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.PostJupiterRouteSwapResponse): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.PostJupiterRouteSwapResponse {
...
export function encodeBinary(value: $.api.PostJupiterRouteSwapResponse): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.PostJupiterRouteSwapResponse {
  const result = getDefaultValue();
