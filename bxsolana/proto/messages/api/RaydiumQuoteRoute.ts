import {
  Type as RaydiumQuoteStep,
  encodeJson as encodeJson_1,
  decodeJson as decodeJson_1,
  encodeBinary as encodeBinary_1,
  decodeBinary as decodeBinary_1,
} from "./RaydiumQuoteStep";
import {
...
export declare namespace $.api {
  export interface RaydiumQuoteRoute {
    inAmount: number;
    outAmount: number;
    outAmountMin: number;
    steps: RaydiumQuoteStep[];
  }
}
export type Type = $.api.RaydiumQuoteRoute;

export function getDefaultValue(): $.api.RaydiumQuoteRoute {
  return {
    inAmount: 0,
    outAmount: 0,
    outAmountMin: 0,
...
export function createValue(partialValue: Partial<$.api.RaydiumQuoteRoute>): $.api.RaydiumQuoteRoute {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.api.RaydiumQuoteRoute): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.api.RaydiumQuoteRoute {
...
export function encodeBinary(value: $.api.RaydiumQuoteRoute): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.api.RaydiumQuoteRoute {
  const result = getDefaultValue();
