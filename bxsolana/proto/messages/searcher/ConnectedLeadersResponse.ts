...
export declare namespace $.searcher {
  export interface ConnectedLeadersResponse {
    connectedValidators: Map<string, SlotList>;
  }
}
export type Type = $.searcher.ConnectedLeadersResponse;

export function getDefaultValue(): $.searcher.ConnectedLeadersResponse {
  return {
    connectedValidators: new Map(),
  };
}

export function createValue(partialValue: Partial<$.searcher.ConnectedLeadersResponse>): $.searcher.ConnectedLeadersResponse {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.searcher.ConnectedLeadersResponse): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.searcher.ConnectedLeadersResponse {
...
export function encodeBinary(value: $.searcher.ConnectedLeadersResponse): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.searcher.ConnectedLeadersResponse {
  const result = getDefaultValue();
