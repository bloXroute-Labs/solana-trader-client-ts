...
export const methodDescriptors = {
  ...
  getRaydiumCPMMQuotes: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetRaydiumCPMMQuotesRequest) => JSON.stringify(encodeJson_16(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_17,
      deserializeBinary: decodeBinary_17,
      serializeJson: (value: GetRaydiumCPMMQuotesResponse) => JSON.stringify(encodeJson_17(value)),
    },
  },
  getRaydiumPrices: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetRaydiumPricesRequest) => JSON.stringify(encodeJson_18(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_19,
      deserializeBinary: decodeBinary_19,
      serializeJson: (value: GetRaydiumPricesResponse) => JSON.stringify(encodeJson_19(value)),
    },
  },
  getRaydiumCLMMQuotes: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetRaydiumCLMMQuotesRequest) => JSON.stringify(encodeJson_20(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_21,
      deserializeBinary: decodeBinary_21,
      serializeJson: (value: GetRaydiumCLMMQuotesResponse) => JSON.stringify(encodeJson_21(value)),
    },
  },
  getRaydiumCLMMPools: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetRaydiumCLMMPoolsRequest) => JSON.stringify(encodeJson_22(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_23,
      deserializeBinary: decodeBinary_23,
      serializeJson: (value: GetRaydiumCLMMPoolsResponse) => JSON.stringify(encodeJson_23(value)),
    },
  },
  postRaydiumCLMMSwap: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostRaydiumSwapRequest) => JSON.stringify(encodeJson_24(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_25,
      deserializeBinary: decodeBinary_25,
      serializeJson: (value: PostRaydiumSwapResponse) => JSON.stringify(encodeJson_25(value)),
    },
  },
  postRaydiumCLMMRouteSwap: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostRaydiumRouteSwapRequest) => JSON.stringify(encodeJson_26(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_27,
      deserializeBinary: decodeBinary_27,
      serializeJson: (value: PostRaydiumRouteSwapResponse) => JSON.stringify(encodeJson_27(value)),
    },
  },
  postRaydiumSwap: {
  ...
  postRaydiumCPMMSwap: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostRaydiumCPMMSwapRequest) => JSON.stringify(encodeJson_28(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_29,
      deserializeBinary: decodeBinary_29,
      serializeJson: (value: PostRaydiumCPMMSwapResponse) => JSON.stringify(encodeJson_29(value)),
    },
  },
  getJupiterQuotes: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetJupiterQuotesRequest) => JSON.stringify(encodeJson_30(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_31,
      deserializeBinary: decodeBinary_31,
      serializeJson: (value: GetJupiterQuotesResponse) => JSON.stringify(encodeJson_31(value)),
    },
  },
  getJupiterPrices: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetJupiterPricesRequest) => JSON.stringify(encodeJson_32(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_33,
      deserializeBinary: decodeBinary_33,
      serializeJson: (value: GetJupiterPricesResponse) => JSON.stringify(encodeJson_33(value)),
    },
  },
  postJupiterSwap: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostJupiterSwapRequest) => JSON.stringify(encodeJson_34(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_35,
      deserializeBinary: decodeBinary_35,
      serializeJson: (value: PostJupiterSwapResponse) => JSON.stringify(encodeJson_35(value)),
    },
  },
  postRaydiumSwapInstructions: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostRaydiumSwapInstructionsRequest) => JSON.stringify(encodeJson_36(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_37,
      deserializeBinary: decodeBinary_37,
      serializeJson: (value: PostRaydiumSwapInstructionsResponse) => JSON.stringify(encodeJson_37(value)),
    },
  },
  postJupiterSwapInstructions: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostJupiterSwapInstructionsRequest) => JSON.stringify(encodeJson_38(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_39,
      deserializeBinary: decodeBinary_39,
      serializeJson: (value: PostJupiterSwapInstructionsResponse) => JSON.stringify(encodeJson_39(value)),
    },
  },
  postJupiterRouteSwap: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostJupiterRouteSwapRequest) => JSON.stringify(encodeJson_40(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_41,
      deserializeBinary: decodeBinary_41,
      serializeJson: (value: PostJupiterRouteSwapResponse) => JSON.stringify(encodeJson_41(value)),
    },
  },
  getMarketsV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetMarketsRequestV2) => JSON.stringify(encodeJson_42(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_43,
      deserializeBinary: decodeBinary_43,
      serializeJson: (value: GetMarketsResponseV2) => JSON.stringify(encodeJson_43(value)),
    },
  },
  getTickersV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetTickersRequestV2) => JSON.stringify(encodeJson_44(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_45,
      deserializeBinary: decodeBinary_45,
      serializeJson: (value: GetTickersResponseV2) => JSON.stringify(encodeJson_45(value)),
    },
  },
  getOrderbookV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetOrderbookRequestV2) => JSON.stringify(encodeJson_46(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_47,
      deserializeBinary: decodeBinary_47,
      serializeJson: (value: GetOrderbookResponseV2) => JSON.stringify(encodeJson_47(value)),
    },
  },
  getMarketDepthV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetMarketDepthRequestV2) => JSON.stringify(encodeJson_48(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_49,
      deserializeBinary: decodeBinary_49,
      serializeJson: (value: GetMarketDepthResponseV2) => JSON.stringify(encodeJson_49(value)),
    },
  },
  postOrderV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostOrderRequestV2) => JSON.stringify(encodeJson_50(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_51,
      deserializeBinary: decodeBinary_51,
      serializeJson: (value: PostOrderResponse) => JSON.stringify(encodeJson_51(value)),
    },
  },
  postCancelOrderV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostCancelOrderRequestV2) => JSON.stringify(encodeJson_52(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_53,
      deserializeBinary: decodeBinary_53,
      serializeJson: (value: PostCancelOrderResponseV2) => JSON.stringify(encodeJson_53(value)),
    },
  },
  postReplaceOrderV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostReplaceOrderRequestV2) => JSON.stringify(encodeJson_54(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_51,
      deserializeBinary: decodeBinary_51,
  ...
  postZetaCrossMarginAccount: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostZetaCrossMarginAccountRequest) => JSON.stringify(encodeJson_55(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_56,
      deserializeBinary: decodeBinary_56,
      serializeJson: (value: PostZetaCrossMarginAccountResponse) => JSON.stringify(encodeJson_56(value)),
    },
  },
  postSettleV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostSettleRequestV2) => JSON.stringify(encodeJson_57(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_58,
      deserializeBinary: decodeBinary_58,
      serializeJson: (value: PostSettleResponse) => JSON.stringify(encodeJson_58(value)),
    },
  },
  getOpenOrdersV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetOpenOrdersRequestV2) => JSON.stringify(encodeJson_59(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_60,
      deserializeBinary: decodeBinary_60,
      serializeJson: (value: GetOpenOrdersResponseV2) => JSON.stringify(encodeJson_60(value)),
    },
  },
  getUnsettledV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetUnsettledRequestV2) => JSON.stringify(encodeJson_61(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_62,
      deserializeBinary: decodeBinary_62,
      serializeJson: (value: GetUnsettledResponse) => JSON.stringify(encodeJson_62(value)),
    },
  },
  getPrice: {
    methodName: "GetPrice",
    ...
    requestType: {
      ...
      serializeJson: (value: GetPriceRequest) => JSON.stringify(encodeJson_63(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_64,
      deserializeBinary: decodeBinary_64,
      serializeJson: (value: GetPriceResponse) => JSON.stringify(encodeJson_64(value)),
    },
  },
  getMarkets: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetMarketsRequest) => JSON.stringify(encodeJson_65(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_66,
      deserializeBinary: decodeBinary_66,
      serializeJson: (value: GetMarketsResponse) => JSON.stringify(encodeJson_66(value)),
    },
  },
  getPools: {
    methodName: "GetPools",
    ...
    requestType: {
      ...
      serializeJson: (value: GetPoolsRequest) => JSON.stringify(encodeJson_67(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_68,
      deserializeBinary: decodeBinary_68,
      serializeJson: (value: GetPoolsResponse) => JSON.stringify(encodeJson_68(value)),
    },
  },
  getTickers: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetTickersRequest) => JSON.stringify(encodeJson_69(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_70,
      deserializeBinary: decodeBinary_70,
      serializeJson: (value: GetTickersResponse) => JSON.stringify(encodeJson_70(value)),
    },
  },
  getKline: {
    methodName: "GetKline",
    ...
    requestType: {
      ...
      serializeJson: (value: GetKlineRequest) => JSON.stringify(encodeJson_71(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_72,
      deserializeBinary: decodeBinary_72,
      serializeJson: (value: GetKlineResponse) => JSON.stringify(encodeJson_72(value)),
    },
  },
  getOrderbook: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetOrderbookRequest) => JSON.stringify(encodeJson_73(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_74,
      deserializeBinary: decodeBinary_74,
      serializeJson: (value: GetOrderbookResponse) => JSON.stringify(encodeJson_74(value)),
    },
  },
  getMarketDepth: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetMarketDepthRequest) => JSON.stringify(encodeJson_75(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_76,
      deserializeBinary: decodeBinary_76,
      serializeJson: (value: GetMarketDepthResponse) => JSON.stringify(encodeJson_76(value)),
    },
  },
  getTrades: {
    ...
    responseType: {
      ...
      serializeJson: (value: GetTradesResponse) => JSON.stringify(encodeJson_78(value)),
    },
  },
  getQuotes: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetQuotesRequest) => JSON.stringify(encodeJson_79(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_80,
      deserializeBinary: decodeBinary_80,
      serializeJson: (value: GetQuotesResponse) => JSON.stringify(encodeJson_80(value)),
    },
  },
  getServerTime: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetServerTimeRequest) => JSON.stringify(encodeJson_81(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_82,
      deserializeBinary: decodeBinary_82,
      serializeJson: (value: GetServerTimeResponse) => JSON.stringify(encodeJson_82(value)),
    },
  },
  getRecentBlockHash: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetRecentBlockHashRequest) => JSON.stringify(encodeJson_83(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_84,
      deserializeBinary: decodeBinary_84,
      serializeJson: (value: GetRecentBlockHashResponse) => JSON.stringify(encodeJson_84(value)),
    },
  },
  getRecentBlockHashV2: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetRecentBlockHashRequestV2) => JSON.stringify(encodeJson_85(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_86,
      deserializeBinary: decodeBinary_86,
      serializeJson: (value: GetRecentBlockHashResponseV2) => JSON.stringify(encodeJson_86(value)),
    },
  },
  getPriorityFee: {
    ...
    requestType: {
      ...
      serializeJson: (value: GetPriorityFeeRequest) => JSON.stringify(encodeJson_87(value)),
    },
    responseType: {
  ...
  postPumpFunSwapSol: {
    ...
    requestType: {
      ...
      serializeJson: (value: PostPumpFunSwapRequestSol) => JSON.stringify(encodeJson_146(value)),
    },
    responseType: {
      serializeBinary: encodeBinary_145,
      deserializeBinary: decodeBinary_145,
